 ...
 */
public class WLMovieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_wlmovie, container, false);
    ...
    private Call<MoviesResponse> callTopRatedMoviesApi() {
        return movieService.getWatchlistMovie(
