...
public class CastCombinedAdapter extends RecyclerView.Adapter<CastCombinedAdapter.MyViewGHolder> {
    private Context mContext;
    private List<CastCombined> movieList;

    public CastCombinedAdapter(Context mContext, List<CastCombined> movieList) {
    ...
    public void onBindViewHolder(MyViewGHolder viewHolder, int i) {
        ...
        if (movieList.get(i).getMediaType().equals("movie")){
            ...
            Glide.with(mContext)
                    ...
                    .placeholder(R.drawable.load)
                    .into(viewHolder.iv_postercast);
            viewHolder.tv_judul_cast.setText(movieList.get(i).getName());
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (pos != RecyclerView.NO_POSITION){
                        CastCombined clickedDataItem = movieList.get(pos);
