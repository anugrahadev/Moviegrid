 ...
 */
public class TVvideosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tvvideos, container, false);
    ...
    private void loadJSONTrailer() {
        ...
        Call<TrailerResponse> call = apiservices.getTrailertv(id, BuildConfig.THE_MOVIE_DB_API_TOKEN);
