...
public class TVPaginationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    TVPaginationAdapter(ArrayList<DataFilter> arrayList){
        this.arrayList = arrayList;
    }

    public TVPaginationAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case LOADING:
                ...
                viewHolder = new TVPaginationAdapter.LoadingVH(v2);
                break;
        }
        return viewHolder;
    }
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        viewHolder = new TVPaginationAdapter.MovieVH(v1);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                final TVPaginationAdapter.MovieVH movieVH = (TVPaginationAdapter.MovieVH) holder;
